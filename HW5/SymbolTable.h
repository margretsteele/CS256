...
public:
    ...
    int findEntryNumParams(string theName) 
    {
	    map<string, SYMBOL_TABLE_ENTRY>::iterator itr;
	    if ((itr = hashTable.find(theName)) == hashTable.end())
		    return(UNDEFINED);
	    else return(itr->second.getNumParams());
    }

    int findEntryReturnType(string theName) 
    {
	    map<string, SYMBOL_TABLE_ENTRY>::iterator itr;
	    if ((itr = hashTable.find(theName)) == hashTable.end())
		    return(UNDEFINED);
    ...
    int findEntryIntValue(string theName) 
    {
	    map<string, SYMBOL_TABLE_ENTRY>::iterator itr;
	    if ((itr = hashTable.find(theName)) == hashTable.end())
		    return(UNDEFINED);
	    else return(itr->second.getIntValue());
    }

    string findEntryStrValue(string theName) 
    {
	    map<string, SYMBOL_TABLE_ENTRY>::iterator itr;
	    if ((itr = hashTable.find(theName)) == hashTable.end())
		    return("");
	    else return(itr->second.getStrValue());
    }
};
